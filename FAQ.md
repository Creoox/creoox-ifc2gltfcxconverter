...
## Sample conversion stats to illustrate resource consumption: 21 IFC files tested internally (20 random models + Baku Olympic Stadium)

### cxconverter v5.8.14 — 21 models tested

All models except Baku Olympic Stadium were converted using 2 vCPU & 4 GB RAM.
